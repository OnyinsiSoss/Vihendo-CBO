...
const aboutUs = () => {
  return (
    <div className=" p-10 shadow-lg  hover:shadow-2xl mx-20 my-10 transition-shadow duration-300">
      <div className="flex flex-col md:justify-around md:items-start gap-8  my-10">
        <div className="">
